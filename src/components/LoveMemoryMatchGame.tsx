...
import { Heart, Clock, Trophy, Brain, HelpCircle, CheckCircle, User, Camera, Upload } from 'lucide-react';

interface LoveMemoryMatchGameProps {
  onComplete: () => void;
  onBack: () => void;
}
...
const LoveMemoryMatchGame: React.FC<LoveMemoryMatchGameProps> = ({ onComplete, onBack }) => {
  ...
  // Using romantic emojis as placeholders
  const images = ['💖', '🌹', '💝', '🌈', '💕', '🎉', '🦄', '💐'];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div className="bg-pink-50 border-2 border-pink-200 rounded-xl p-4">
              <div className="flex items-center mb-3">
                <Brain className="w-5 h-5 text-pink-600 mr-2" />
                <h4 className="text-lg font-semibold text-pink-800">Memory Phase (6s)</h4>
              </div>
            ...
            <div className="bg-rose-50 border-2 border-rose-200 rounded-xl p-4">
              <div className="flex items-center mb-3">
                <HelpCircle className="w-5 h-5 text-rose-600 mr-2" />
                <h4 className="text-lg font-semibold text-rose-800">Game Phase (45s)</h4>
              </div>
            ...
            <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4">
              <div className="flex items-center mb-3">
                ...
                <h4 className="text-lg font-semibold text-red-800">Scoring System</h4>
              </div>
            ...
            <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-4">
              <div className="flex items-center mb-3">
                ...
                <h4 className="text-lg font-semibold text-purple-800">Victory Condition</h4>
              </div>
              <p className="text-purple-700 text-sm">
                Score 20+ points or find 4+ matches to prove your loving memory skills and continue your journey!
              </p>
            </div>
          </div>
        ...
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 text-center relative overflow-hidden max-w-2xl w-full">
          ...
          <div className="bg-gradient-to-r from-pink-100 to-rose-100 rounded-2xl p-6 mb-6 border border-pink-200">
            <p className="text-lg text-slate-700 leading-relaxed mb-4">
              You need <strong>20+ points</strong> or <strong>4+ matches</strong> to continue your romantic journey.
            </p>
        ...
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20">
          <div className="text-center mb-6">
            ...
            <div className="text-lg">
              <span className="text-pink-600 font-semibold">Points: {points}</span>
              <span className="text-slate-400 mx-2">|</span>
              <span className="text-pink-600 font-semibold">Matches: {matches}/8</span>
            </div>
          </div>
              ...
              <div
                ...
                className={`
                  ...
                  ${card.isFlipped || card.isMatched
                    ...
                    : 'bg-gradient-to-br from-pink-400 to-rose-500 border-pink-300 hover:scale-105'
                  }
                  ${card.isMatched ? 'ring-4 ring-pink-400 ring-opacity-50' : ''}
...
export default LoveMemoryMatchGame;