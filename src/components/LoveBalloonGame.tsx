...
import { Heart, Clock, Trophy, Target, HelpCircle, Zap } from 'lucide-react';

interface LoveBalloonGameProps {
  onComplete: () => void;
  onBack: () => void;
}
...
const LoveBalloonGame: React.FC<LoveBalloonGameProps> = ({ onComplete, onBack }) => {
  ...
  const colors = ['#FF6B9D', '#F472B6', '#EC4899', '#DB2777', '#BE185D', '#9D174D', '#F8BBD9', '#FECACA'];
        ...
        <div className="bg-white/95 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-white/20 max-w-4xl w-full">
          ...
          <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-800">Love Balloon Pop</h3>
          ...
          <div className="text-center mb-6">
            <div className="flex items-center justify-center space-x-2 mb-3">
              ...
              <h3 className="text-2xl font-bold text-slate-800">Love Balloon Pop Rules</h3>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div className="bg-pink-50 border-2 border-pink-200 rounded-xl p-4">
              <div className="flex items-center mb-3">
                ...
                <h4 className="text-lg font-semibold text-pink-800">Game Objective</h4>
              </div>
              <ul className="text-pink-700 text-sm space-y-1">
                <li>• Pop as many love balloons as possible</li>
            ...
            <div className="bg-rose-50 border-2 border-rose-200 rounded-xl p-4">
              <div className="flex items-center mb-3">
                <Trophy className="w-5 h-5 text-rose-600 mr-2" />
          ...
          <div className="bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl p-4 mb-6 border border-pink-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="text-center">
                ...
                <p className="text-sm text-slate-600">20 love balloons appear in container</p>
              </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-50 flex items-center justify-center p-6">
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 text-center">
          ...
          <p className="text-xl text-slate-600">Love balloon popping challenge starting soon...</p>
        ...
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 text-center relative overflow-hidden max-w-2xl w-full">
          ...
          <div className="bg-gradient-to-r from-pink-100 to-rose-100 rounded-2xl p-6 mb-6 border border-pink-200">
            <p className="text-lg text-slate-700 leading-relaxed mb-4">
              You need <strong>10+ points</strong> to complete the love challenge.
            </p>
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-slate-500">
              Fresh love balloons will be loaded for your next attempt
            </p>
          </div>
        ...
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 text-center relative overflow-hidden max-w-2xl w-full">
          ...
          <div className="bg-gradient-to-r from-pink-100 to-rose-100 rounded-2xl p-6 mb-6 border border-pink-200">
            <p className="text-lg text-slate-700 leading-relaxed">
              Excellent reflexes! You've successfully completed the final challenge of the Love Path. Your romantic journey is now complete!
            </p>
          </div>
          <div className="text-2xl font-bold text-pink-600">
            Completing Love Path in {winTimer} seconds...
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-50 p-4">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20">
          <div className="text-center mb-6">
            <h2 className="text-3xl font-bold text-slate-800 mb-2">Love Balloon Challenge</h2>
            <div className="text-center mb-4">
          ...
          {/* Game Container */}
          <div className="relative h-96 bg-gradient-to-br from-pink-100 via-rose-100 to-red-100 rounded-2xl overflow-hidden border-4 border-pink-300 mb-6">
          ...
          <div className="text-center">
            <p className="text-sm text-slate-600">
              Pop 10 or more balloons out of {totalBalloons} to complete the love challenge!
            </p>
          </div>
        </div>
      </div>
...
export default LoveBalloonGame;